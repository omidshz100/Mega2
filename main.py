...
input_directory = "/Users/omidshojaeianzanjani/Desktop/Mega2/input_images"
output_directory = "/Users/omidshojaeianzanjani/Desktop/Mega2/outputs"
...
target_sizes = [
    ...
    ((2048, 2732), "output_images_iPad 2 edition 12.9 inch - 2048 x 2732"),
    ((2732, 2048), "output_images_iPad 2 edition 12.9 inch - 2732 x 2048"),
    # Add more target sizes and corresponding output directories as needed
]
# Ensure the output directories exist
for _, output_dir in target_sizes:
    folder_path = os.path.join(output_directory, output_dir)
...
for filename in os.listdir(input_directory):
    if filename.endswith(".jpg") or filename.endswith(".png"):
        ...
        for itemInfo in target_sizes:
            print(itemInfo[1])
            target_size = itemInfo[0]
            output_dir = os.path.join(output_directory, itemInfo[1])
            # Resize the image
